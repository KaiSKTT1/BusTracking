...
CREATE TABLE `notifications` (
  ...
  `type` enum('picked_up','not_picked_up','incident','general') NOT NULL DEFAULT 'general',
...
INSERT INTO `notifications` (`notification_id`, `sender_id`, `receiver_id`, `student_id`, `bus_id`, `message`, `type`, `status`, `created_at`, `updated_at`) VALUES
(9, 2, NULL, 1, 1, 'Tài xế đã đón học sinh ID 1.', 'picked_up', 'unread', '2025-10-28 18:19:40', '2025-10-28 18:19:40'),
(10, 2, NULL, 1, 1, 'Không thể đón học sinh ID 1. Lý do: Đã trả học sinh về trường', 'not_picked_up', 'unread', '2025-10-28 18:19:46', '2025-10-28 18:19:46'),
(11, 2, NULL, 2, 1, 'Không thể đón học sinh ID 2. Lý do: Đã trả học sinh về trường', 'not_picked_up', 'unread', '2025-10-28 18:19:52', '2025-10-28 18:19:52'),
(12, 2, NULL, NULL, 1, 'ádweqe', 'incident', 'unread', '2025-10-28 18:20:36', '2025-10-28 18:20:36');
...
INSERT INTO `student` (`student_id`, `name`, `school_id`, `note`, `id_ph`, `bus_id`) VALUES
(1, 'Nguyễn Văn An', 1, 'Lớp 5A', 5, 1),
(2, 'Trần Thị Bình', 1, 'Lớp 4B', 5, 1),
(3, 'Lê Hoàng Cường', 2, 'Lớp 7A', 6, 2),
(4, 'Phạm Gia Huy', 2, 'Lớp 8B', 6, NULL),
(5, 'Vũ Minh Anh', 1, 'Lớp 5C', 5, NULL);
...
(2, 2, 'driver11', 'driver123', 'driver1@example.com', 'active'),
...
ALTER TABLE `notifications`
  ...
  ADD KEY `fk_notifications_bus` (`bus_id`);
...
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `fk_notifications_bus` FOREIGN KEY (`bus_id`) REFERENCES `bus` (`bus_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_notifications_receiver` FOREIGN KEY (`receiver_id`) REFERENCES `user_account` (`user_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_notifications_sender` FOREIGN KEY (`sender_id`) REFERENCES `user_account` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_notifications_student` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE SET NULL;
...
ALTER TABLE `student`
  ...
  ADD CONSTRAINT `fk_student_bus` FOREIGN KEY (`bus_id`) REFERENCES `bus` (`bus_id`) ON DELETE SET NULL ON UPDATE CASCADE,
